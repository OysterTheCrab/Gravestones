# Slot 101
data modify storage otc_grave:data Item set from storage rx.playerdb:io player.data.otc_grave.Inventories[{Slot:101b}]
...
item replace entity @s armor.legs from block -30000000 -55 1300 container.0
