# Slot 2
data modify storage otc_grave:data Item set from storage rx.playerdb:io player.data.otc_grave.Inventories[{Slot:2b}]
...
item replace entity @s hotbar.2 from block -30000000 -55 1300 container.0
