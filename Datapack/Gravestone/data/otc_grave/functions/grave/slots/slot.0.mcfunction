# Slot 0
data modify storage otc_grave:data Item set from storage rx.playerdb:io player.data.otc_grave.Inventories[{Slot:0b}]
...
item replace entity @s hotbar.0 from block -30000000 -55 1300 container.0
