# Slot 30
data modify storage otc_grave:data Item set from storage rx.playerdb:io player.data.otc_grave.Inventories[{Slot:30b}]
...
item replace entity @s inventory.21 from block -30000000 -55 1300 container.0
