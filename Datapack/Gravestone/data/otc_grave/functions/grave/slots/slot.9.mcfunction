# Slot 9
data modify storage otc_grave:data Item set from storage rx.playerdb:io player.data.otc_grave.Inventories[{Slot:9b}]
...
item replace entity @s inventory.0 from block -30000000 -55 1300 container.0
