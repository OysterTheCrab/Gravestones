# Slot 8
data modify storage otc_grave:data Item set from storage rx.playerdb:io player.data.otc_grave.Inventories[{Slot:8b}]
...
item replace entity @s hotbar.8 from block -30000000 -55 1300 container.0
