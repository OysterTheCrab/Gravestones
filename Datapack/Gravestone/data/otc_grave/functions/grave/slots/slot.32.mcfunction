# Slot 32
data modify storage otc_grave:data Item set from storage rx.playerdb:io player.data.otc_grave.Inventories[{Slot:32b}]
...
item replace entity @s inventory.23 from block -30000000 -55 1300 container.0
