...
execute if score $differs otcId matches 1 store success score $differs otcInteract run data modify storage otc_interact:player verify set from entity @s interaction.player
